...
======
This is the official repository and issue-tracker for All the Magic - Arcana 1.21.1

Does "All The Magic" *really* contain ALL THE MAGICS? No, of course not.

Need Help?
======
When reporting an issue put the version number before the issue title! Such as [FULL][0.1] My game is broken! Also include any added mods you may have put in, into the description of the issue.
